<section class="py-16 bg-[#fdfbf7]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @php
            $galleryImages = [
                ['id' => 1, 'title' => 'From Our Kitchen', 'url' => asset('images/image2.jpeg')],
                ['id' => 2, 'title' => 'Serving Tradition', 'url' => asset('images/image3.jpeg')],
                ['id' => 3, 'title' => 'Serving Guests with Warm Hospitality', 'url' => 'https://images.unsplash.com/photo-1588166524941-3bf61a9c41db?auto=format&fit=crop&w=800&q=80'],
                ['id' => 4, 'title' => 'Religious Function & Seemantha Feast', 'url' => 'https://images.pexels.com/photos/6359420/pexels-photo-6359420.jpeg?auto=compress&cs=tinysrgb&w=800'],
                ['id' => 5, 'title' => 'Authentic Bisibele Bath', 'url' => 'https://images.pexels.com/photos/6363501/pexels-photo-6363501.jpeg?auto=compress&cs=tinysrgb&w=800'],
            ];
        @endphp
